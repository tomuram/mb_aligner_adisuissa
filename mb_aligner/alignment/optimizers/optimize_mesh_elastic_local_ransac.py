...
from mb_aligner.common.affine_transforms_grouper import AffineTransformsGrouper
...
class ElasticMeshOptimizerLocalRansac(object):
    ...
    #     filter_distance_multiplier = kwargs.get("filter_distance_multiplier", None)
        ...
        self._local_ransac_params = kwargs.get("local_ransac_params", {})
        self._affine_grouper = AffineTransformsGrouper(**self._local_ransac_params)
